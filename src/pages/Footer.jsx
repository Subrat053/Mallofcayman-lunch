...
const YouTubeIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    <path d="M23.498 6.186a2.994 2.994 0 0 0-2.108-2.121C19.68 3.5 12 3.5 12 3.5s-7.68 0-9.39.565A2.994 2.994 0 0 0 .502 6.186 31.77 31.77 0 0 0 0 12a31.77 31.77 0 0 0 .502 5.814 2.994 2.994 0 0 0 2.108 2.121C4.32 20.5 12 20.5 12 20.5s7.68 0 9.39-.565a2.994 2.994 0 0 0 2.108-2.121A31.77 31.77 0 0 0 24 12a31.77 31.77 0 0 0-.502-5.814zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"/>
  </svg>
);
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://www.instagram.com/mallofcayman?igsh=MXB4Y21vNWc0bDcwMw=="
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61586438575556"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://youtube.com/@mallofcayamn?si=Y-zkaoPqiVMG_Jat"
              target="_blank"
              rel="noopener noreferrer"
